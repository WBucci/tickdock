...
- Tick B7P5E9 is 264 AA (annotated as fragment) vs human Q53F39 at 341 AA — divergence outside the catalytic domain. Flanking regions and transmembrane topology may offer allosteric selectivity handles.
...
1. **Parallel docking: human PGAP5 (Q53F39) vs same top 5 ligands** — compute selectivity ratio (tick score / human score). If CHEMBL9171 scores worse against human PGAP5 → selectivity window exists → paper argument significantly strengthened.
...
Human Q53F39 AlphaFold mean pLDDT: 89.7

| Ligand | Tick B7P5E9 (kcal/mol) | Human Q53F39 (kcal/mol) | Ratio | Verdict |
|--------|------------------------|--------------------------|-------|---------|
...
| Ligand | Tick B7P5E9 (kcal/mol) | Human Q53F39 (kcal/mol) | Ratio | Verdict |
|--------|------------------------|--------------------------|-------|---------|
| CHEMBL9171 | -13.125 | -6.791 | 0.517 | SELECTIVE ✓✓ |
| CHEMBL8905 | -12.995 | -6.277 | 0.483 | SELECTIVE ✓✓ |
| CHEMBL9203 | -12.373 | -6.369 | 0.515 | SELECTIVE ✓✓ |
| CHEMBL429008 | -11.885 | -5.847 | 0.492 | SELECTIVE ✓✓ |
| CHEMBL10161 | -11.781 | -6.795 | 0.577 | SELECTIVE ✓✓ |
...
| Ligand | Tick B7PY20 (kcal/mol) | Human TRβ (kcal/mol) | Ratio | Verdict |
|--------|------------------------|----------------------|-------|---------|
| CHEMBL8922 | -12.034 | +1.751 | -0.146 | SELECTIVE ✓✓ |
| CHEMBL429379 | -11.785 | -7.703 | 0.654 | Mod selective ✓ |
| CHEMBL9203 | -11.755 | +1.589 | -0.135 | SELECTIVE ✓✓ |
| CHEMBL9190 | -11.604 | -3.574 | 0.308 | SELECTIVE ✓✓ |
| CHEMBL8920 | -11.581 | -2.524 | 0.218 | SELECTIVE ✓✓ |
...
| Ligand | Tick B7P5E9 (kcal/mol) | Human Q53F39 (kcal/mol) | Ratio | Verdict |
|--------|------------------------|--------------------------|-------|---------|
| CHEMBL94259 | -14.000 | -6.725 | 0.480 | SELECTIVE ✓✓ |
| CHEMBL91403 | -13.900 | -6.680 | 0.481 | SELECTIVE ✓✓ |
| CHEMBL90184 | -13.300 | -6.460 | 0.486 | SELECTIVE ✓✓ |
| CHEMBL9405 | -13.200 | -6.349 | 0.481 | SELECTIVE ✓✓ |
| CHEMBL328658 | -13.100 | -6.331 | 0.483 | SELECTIVE ✓✓ |
...
| Ligand | Tick B7PY20 (kcal/mol) | Human TRβ (kcal/mol) | Ratio | Verdict |
|--------|------------------------|----------------------|-------|---------|
| CHEMBL9718 | -13.100 | -1.673 | 0.128 | SELECTIVE ✓✓ |
| CHEMBL329131 | -12.700 | -4.095 | 0.322 | SELECTIVE ✓✓ |
| CHEMBL90647 | -12.700 | +0.958 | -0.075 | SELECTIVE ✓✓ |
| CHEMBL89845 | -12.600 | -4.510 | 0.358 | SELECTIVE ✓✓ |
| CHEMBL94259 | -12.600 | -2.779 | 0.221 | SELECTIVE ✓✓ |
...
Dog PGAP5 (A0A8C0WKF3 — A0A8C0WKF3_CASCN) AlphaFold mean pLDDT: 89.8

Selectivity ratio = dog_score / tick_score; ratio < 0.8 = tick-selective (pet-safe).

| Ligand | Tick B7P5E9 (kcal/mol) | Dog PGAP5 (kcal/mol) | Ratio | Verdict |
|--------|------------------------|----------------------|-------|---------|
| CHEMBL94259 | -14.000 | +1.670 | -0.119 | SELECTIVE |
| CHEMBL91403 | -13.900 | +4.591 | -0.330 | SELECTIVE |
| CHEMBL90184 | -13.300 | +0.749 | -0.056 | SELECTIVE |
| CHEMBL9405 | -13.200 | +7.088 | -0.537 | SELECTIVE |
| CHEMBL328658 | -13.100 | -4.376 | 0.334 | SELECTIVE |
