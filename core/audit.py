...
sapiens. Proteins with sequence identity ≥ {int(MAX_HUMAN_HOMOLOGY*100)}% to any human
protein were flagged as elevated (medium) mammalian-toxicity risk; those with
≥ {int(HIGH_HUMAN_HOMOLOGY*100)}% identity were classified as high risk and
deprioritized via a scoring penalty. Proteins with < 20% identity were classified
as tick-specific excellent candidates.
